...
import { BadgePercent, ChevronLeft, ChevronRight, ShieldCheck, Store } from 'lucide-react';
...
const slides = [
  {
    ...
    icon: <BadgePercent size={20} strokeWidth={1.8} />,
  },
  {
    title: 'Mua sắm an toàn, nền tảng bảo vệ 100%',
